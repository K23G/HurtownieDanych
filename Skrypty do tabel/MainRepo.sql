...
-- Wymiar data -- 
CREATE TABLE MainRepo.DimDateTime (ID_DateTime int IDENTITY NOT NULL, DateKey int NULL, FullDate char(10) NULL, DayOfMonth varchar(2) NULL, DayName varchar(20) NULL, DayOfYear varchar(3) NULL, Month varchar(2) NULL, MonthName varchar(20) NULL, MonthOfQuarter varchar(2) NULL, Quarter char(1) NULL, QuarterName varchar(9) NULL, Year char(4) NULL, IsWeekday bit NULL, MilitaryHour int NULL, StandardHour int NULL, TheMinute int NULL, PRIMARY KEY (ID_DateTime));
